...
export const CheckEmail = () => {
  ...
  const data = useAppSelector<ResponseLoginType>(state => state.profile.data)
    ...
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Avatar sx={{ m: 1, bgcolor: 'secondary.main', width: 150, height: 150, textAlign: 'center' }}>MAIL</Avatar>
