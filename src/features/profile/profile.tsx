...
export const Profile = () => {
  const userProfileData = useAppSelector<InitialStateType>(state => state.profile)
  const dispatch = useAppDispatch()
  const a = !userProfileData._id

  if (a) {
    useEffect(() => {
      console.log(1)
      dispatch(addUserDataTC())
    }, [])
  }
  // }
  // if (a) {
  ...
  const onclickHandler = () => {
    console.log('ok', userProfileData)

    const newName = userProfileData.tempName as string

    dispatch(setNewCurrnetNameAC(newName))
        ...
        >
          ...
          >
            ...
            <div className={s.inputContainer}>
              ...
              <SuperButton
                className={s.saveButton + ' ' + customStyle}
